...
class RegisterUserPageMyPlant extends StatefulWidget {

  final VoidCallback showLoginPage;

  const RegisterUserPageMyPlant({
    Key? key,
    required this.showLoginPage,
  }): super(key: key);

  @override
  State<RegisterUserPageMyPlant> createState() => _RegisterUserPageMyPlantState();
}

class _RegisterUserPageMyPlantState extends State<RegisterUserPageMyPlant> {
  //controllers
